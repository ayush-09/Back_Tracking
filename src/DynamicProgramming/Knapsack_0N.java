...
public class Knapsack_0N {

    public static int maxProfit(int[] price, int[] weight,int bagC, int curr,int[][] dp) {
        ...
        int rob=0, dontRob =0;
        if (weight[curr]<=bagC){
            rob = price[curr] + maxProfit(price,weight,bagC-weight[curr],curr,dp);
